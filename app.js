...
app.post("/api/users/add", async (req, res) => {
  ...
  const sql =
    "INSERT INTO t_user (username, email, profile, created_at, password) VALUES(?, ?, NULL, now(), ?)";
...
app.post("/api/articles/add", async (req, res) => {
  ...
  const sql =
    "INSERT INTO t_board (type, title, contents, writer, created_at, updated_at) VALUES(?, ?, ?, ?, now(), now())";
